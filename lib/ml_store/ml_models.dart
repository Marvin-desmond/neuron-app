...
List<MLModel> mlModels = [
  ...
  MLModel(
      "multi-axis-vit.pt",
      "https://github.com/Marvin-desmond/neuron-models-tests/releases/download/v1.0/multiaxis-vision-transformer.ptl",
      "classification",
      FrameWork.pytorch,
      "imagenet",
      Preprocessing(permute: true, normalization: true)),
  ...
  MLModel(
      "yolo-5m-tf.tflite",
      "https://github.com/Marvin-desmond/neuron-models-tests/releases/download/v1.0/yolov5m-fp16.tflite",
      "detection",
      FrameWork.tensorflow,
      "coco",
      Preprocessing(inferenceSize: 640, permute: true)),
